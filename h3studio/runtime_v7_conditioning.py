"""Adaptive VAE residency for native-first v7."""
...
from .runtime_v7 import GIB, hardware_policy

_INSTALLED = False


def install_conditioning_residency_policy_v7() -> None:
    global _INSTALLED
    if _INSTALLED:
        return
    ...
    _INSTALLED = True
    emit("v7.conditioning.vae_policy.install", result="installed", policy=hardware_policy().label)


__all__ = ["install_conditioning_residency_policy_v7"]
