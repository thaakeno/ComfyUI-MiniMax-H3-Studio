"""Optional, privacy-minimal generated-image counter.

All network-facing H3 Studio telemetry lives in this file inside the top-level
``telemetry`` directory. Deleting that directory removes the telemetry runtime.
"""
...
def _cli(argv: Sequence[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="python telemetry/telemetry.py")
