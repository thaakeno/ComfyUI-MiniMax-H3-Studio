...
def build_workflow():
    ...
    nodes = [
        ...
        note(
            ...
            "settings",
            "## Two deliberate stages\n\n- **Analyze image pixels**: one native ComfyUI Qwen3-VL checkpoint creates factual source descriptions and repairs automatic roles.\n- **Detailed prompt**: a deterministic compiler expands those facts without staging a second 8B writer.\n\nFingerprints and descriptions survive workflow reloads, so unchanged references skip analysis. No model downloads automatically.",
            [-910, -180],
            [520, 320],
            11,
        ),
        ...
        note(
            ...
            "troubleshooting",
            "## What local checks prove\n\nSyntax, state migration, prompt compilation, resolution math, routes, registration, and graph integrity are checked here.\n\n> [!IMPORTANT]\n> CUDA generation, installed model filenames, VRAM, speed, and visual quality require the real Lightning workspace. Follow `docs/LIGHTNING_TEST_PLAN.md`.",
            [170, -180],
            [520, 320],
            13,
        ),
        ...
        note(
            ...
            "models",
            "## Model sources\n\n- [MiniMax H3 models, 32B encoder, video VAE](https://huggingface.co/Comfy-Org/MiniMax-H3)\n- [Qwen3-VL image analyzer](https://huggingface.co/Comfy-Org/Qwen3-VL)\n- [Mamad8 experimental Image VAE](https://huggingface.co/Mamad8/MiniMax-H3-Image-VAE)\n- [Kijai LightX artifacts](https://huggingface.co/Kijai/MiniMax-H3_comfy)\n- [Kijai TAEH3 preview](https://huggingface.co/Kijai/MiniMax-H3-TAE)\n- [Mamad8 PDD artifacts](https://huggingface.co/Mamad8/MiniMaxH3_R2V-PDD-Turbo-LoRA-Mamad8) and [required node](https://github.com/mamad8c/ComfyUI-MiniMaxH3-PDD-Mamad8)\n\n> [!NOTE]\n> H3 Studio never downloads these automatically.",
            [1560, 1080],
            [430, 560],
            18,
        ),
