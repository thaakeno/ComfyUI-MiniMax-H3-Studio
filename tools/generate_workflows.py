...
def build_workflow():
    ...
    nodes = [
        ...
        note(
            ...
            "settings",
            "Analyze image pixels uses one native ComfyUI Qwen3-VL checkpoint for factual source descriptions and then repairs auto roles from your @Image sentence. Fingerprinted descriptions survive workflow reloads and unchanged images skip analysis. Fast detailed expansion is deterministic and never stages a second 8B writer model. The selected H3 ConvRot file remains the conditioning encoder; it is not assumed to expose a chat-generation head. No model is downloaded automatically.",
            [-910, -180],
            [520, 320],
            11,
        ),
