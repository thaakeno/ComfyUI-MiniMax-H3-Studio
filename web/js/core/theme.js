...
export function installTheme() {
  ...
  style.textContent = `
    .h3s-studio-panel {
      ...
      --h3s-surface: color-mix(in srgb, var(--h3s-bg) 88%, white 12%);
      --h3s-raised: color-mix(in srgb, var(--h3s-bg) 80%, white 20%);
      ...
      --h3s-accent: #34d3b5;
      --h3s-warning: #e6ad55;
      display: flex; flex-direction: column; gap: 10px; width: 100%; height: 100%; min-height: 0;
      box-sizing: border-box; padding: 10px; overflow: auto; overscroll-behavior: contain;
      color: var(--h3s-text); background: var(--h3s-bg); border: 1px solid var(--h3s-border); border-radius: 10px;
    ...
    .h3s-studio-header { display: flex; align-items: center; justify-content: space-between; gap: 10px; min-height: 28px; }
    .h3s-studio-brand { display: flex; align-items: center; gap: 8px; min-width: 0; }
    .h3s-studio-mark { width: 7px; height: 18px; border-radius: 999px; background: var(--h3s-accent); box-shadow: 0 0 0 1px color-mix(in srgb, var(--h3s-accent) 60%, transparent); }
    .h3s-studio-title { overflow: hidden; color: var(--h3s-text); font-size: 12px; font-weight: 700; letter-spacing: .02em; text-overflow: ellipsis; white-space: nowrap; }
    .h3s-status-pill { flex: none; padding: 3px 7px; border: 1px solid var(--h3s-border); border-radius: 999px; color: var(--h3s-muted); background: var(--h3s-surface); font-size: 10px; }
    ...
    .h3s-section { display: flex; flex-direction: column; gap: 7px; padding: 9px; border: 1px solid var(--h3s-border); border-radius: 9px; background: var(--h3s-surface); }
    .h3s-section-header { display: flex; align-items: center; justify-content: space-between; gap: 8px; }
    .h3s-section-title { color: var(--h3s-muted); font-size: 10px; font-weight: 700; letter-spacing: .08em; text-transform: uppercase; }
    .h3s-grid { display: grid; grid-template-columns: repeat(2, minmax(0,1fr)); gap: 7px; }
    ...
    .h3s-control { width: 100%; min-width: 0; height: 27px; padding: 3px 7px; border: 1px solid var(--h3s-border); border-radius: 6px; outline: none; color: var(--h3s-text); background: var(--h3s-bg); font: inherit; }
    ...
    .h3s-reference-list { display: flex; flex-direction: column; gap: 7px; }
    .h3s-reference-card { display: grid; grid-template-columns: 54px minmax(0,1fr); gap: 8px; padding: 7px; border: 1px solid var(--h3s-border); border-radius: 8px; background: var(--h3s-bg); }
    .h3s-reference-thumb { position: relative; width: 54px; height: 54px; overflow: hidden; border-radius: 7px; background: var(--h3s-raised); }
